							...
							echo '<table width="100%">'; 
								...
								if($_SESSION['user_type_num'] == 2){
									...
									echo '<tr>';
										...
										echo '<td  align="center"><input type="button" id="delete" value="Delete Saved Surveys" onClick="confirm(\'Delete Localy Saved Clients?\');" ></td>'; 
										echo '<td></td>';
									echo '</tr>';								
								}
							echo '</table>';
...
<?php 
	...
	header('Location: survey_offline_static.html');
?>
